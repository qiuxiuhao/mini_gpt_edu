"""Stage 4 新增：generate text with the Multi-Head Attention LM."""
...
def main() -> None:
    """Stage 4 新增：run text generation from command line arguments."""
    parser = argparse.ArgumentParser(
        description="Generate text with a multi-head attention language model."
    )
