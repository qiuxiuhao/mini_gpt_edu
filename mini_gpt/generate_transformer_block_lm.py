"""Stage 5 新增：generate text with the Transformer Block LM."""
...
def main() -> None:
    """Stage 5 新增：run text generation from command line arguments."""
    parser = argparse.ArgumentParser(
        description="Generate text with a one-block Transformer language model."
    )
