"""Stage 5 新增：train the Transformer Block language model."""
...
def main() -> None:
    """Stage 5 新增：run Transformer Block LM training from CLI arguments."""
    parser = argparse.ArgumentParser(
        description="Train a one-block Transformer language model."
    )
